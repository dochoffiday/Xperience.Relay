...
/// <summary>
/// Updates one or more fields on an existing web page, preserving its current published/draft state.
/// Scalar fields go in <see cref="Fields"/>; linked-item fields (where the value is a list of
/// ContentItemGUIDs) go in <see cref="LinkedItemFields"/> — pass an empty list to clear a field.
/// </summary>
[RelayCommand("update-web-page")]
public class UpdateWebPageCommand : IRelayCommand
{
